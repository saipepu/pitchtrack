  ...
  return (
      ...
      >
        <div className="w-full flex justify-start items-center">
          <p className="text-base md:text-4xl font-bold">{event.title}</p>
        </div>
        <div className="w-full flex justify-center ite ms-center">
          <p className="text-xs font-normal md:text-4xl md:font-bold">{speaker}</p>
        </div>
        <div className="hidden md:flex w-full justify-end items-center">
          <p className="text-base md:text-4xl font-bold">Pitchtrack</p>
        </div>
      </div>
  )
}
